...
TEST(OctagonTest, GetCenter) {
    Octagon<double> octagon(Point<double>(0, 0), Point<double>(1, 0), Point<double>(2, 1), Point<double>(3, 2),
                    Point<double>(2, 3), Point<double>(1, 4), Point<double>(0, 4), Point<double>(-1, 3));
